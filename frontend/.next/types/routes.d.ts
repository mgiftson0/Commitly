...
type AppRouteHandlerRoutes = "/api/activities/[id]" | "/api/auth/set-session" | "/api/follows" | "/api/follows/requests" | "/api/follows/status" | "/api/group-goals" | "/api/group-goals/invitations" | "/api/seasonal-cohorts" | "/api/seasonal-goals" | "/api/seasonal-milestones" | "/api/seasonal-templates" | "/api/session/log" | "/auth/callback"
