...
/**
 * COMMITLY - Automatic Setup Script (Non-Interactive)
...
-- Create storage bucket for avatars (this might fail if bucket exists, that's okay)
...
`;
  ...
  try {
    ...
    if (error) {
      console.log('⚠️  Note: Some statements may have failed (this is normal if tables already exist)');
    ...
    console.log('🎉 Your Commitly database is ready to use!\n');
    console.log('Next steps:');
    console.log('1. Configure Auth URLs in Supabase Dashboard');
    ...
    console.error('2. Your service role key has admin permissions');
